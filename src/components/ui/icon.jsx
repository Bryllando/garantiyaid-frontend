const paths = {
  ...
  sunrise: <><path d="M3 18h18M5 22h14M7 18a5 5 0 0 1 10 0M12 2v8m-3-5 3-3 3 3M3 11l2 2M19 13l2-2" /></>,
  sunHigh: <><circle cx="12" cy="12" r="5" fill="currentColor" fillOpacity="0.15" /><path d="M12 1v2M12 21v2M1 12h2M21 12h2M4 4l1.5 1.5M18.5 18.5 20 20M4 20l1.5-1.5M18.5 5.5 20 4" /></>,
  sunset: <><path d="M3 18h18M5 22h14M7 18a5 5 0 0 1 10 0M12 2v8m-3-3 3 3 3-3M3 11l2 2M19 13l2-2" /></>,
  moon: <path d="M20.5 14.5A9 9 0 0 1 9.5 3.5a9 9 0 1 0 11 11Z" />,
  moonStars: <><path d="M18 16A8 8 0 0 1 8 6a8 8 0 1 0 10 10Z" /><path d="m17 2 1 3 3 1-3 1-1 3-1-3-3-1 3-1ZM21 11v2m-1-1h2" /></>,
